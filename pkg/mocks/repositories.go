...
// GetGameInf mocks base method.
func (m *MockGameRepositoryContract) GetGameInf(ctx context.Context, channel string, message func(rueidis.PubSubMessage)) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetGameInf", ctx, channel, message)
	ret0, _ := ret[0].(error)
	return ret0
}

// GetGameInf indicates an expected call of GetGameInf.
func (mr *MockGameRepositoryContractMockRecorder) GetGameInf(ctx, channel, message interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGameInf", reflect.TypeOf((*MockGameRepositoryContract)(nil).GetGameInf), ctx, channel, message)
}

// GetGameInformation mocks base method.
func (m *MockGameRepositoryContract) GetGameInformation(ctx context.Context, gameID string) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockGameRepositoryContract) Matchmaking(ctx context.Context, cards []string, username, gameID, lastMoveTimestamps, king, kingCards string) {
	m.ctrl.T.Helper()
