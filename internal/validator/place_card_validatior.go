...
func PlaceCardValidator(gameService game_service.GameService, cardsService cards_service.CardsService, data PlaceCardValidatorData) *errors.ValidationError {
    ...
    if !my_slice.Has(cards_service.Cards, data.Card) {
